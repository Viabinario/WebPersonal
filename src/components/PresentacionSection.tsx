import imgLinkedIn from "../assets/eb32313f181d7f397e280d071d68cd4848de3309.png";
import imgGitHub from "../assets/ba860023c4945015a1341b916ead911ab33959ca.png";
import imgBehance from "../assets/ce87b991d33908119ebd53423d76d4d176fa3dd6.png";
import imgNotion from "../assets/f4070059249511aee028c2a23241923404682ade.png";
import imgYouTube from "../assets/2a49aaca2afd902bddff6a117e6ba2b56e221665.png";
      ...
      >
        <div className="w-full bg-[#e8d8c9] rounded-[22px] border-2 border-[#5a3e26] border-dashed p-6 md:p-12 lg:p-[48px] shadow-[25px_25px_10px_0px_rgba(0,0,0,0),16px_16px_9px_0px_rgba(0,0,0,0.02),9px_9px_8px_0px_rgba(0,0,0,0.07),4px_4px_6px_0px_rgba(0,0,0,0.12),1px_1px_3px_0px_rgba(0,0,0,0.14)]">
          <p className="font-['Roboto:Regular',sans-serif] text-sm md:text-base lg:text-[14px] text-black text-justify leading-normal">
            Lorem ipsum dolor sit amet consectetur. Congue mauris id rhoncus adipiscing amet pharetra ornare amet luctus. 
            Suspendisse lectus viverra sollicitudin nibh imperdiet diam vitae. Scelerisque mi urna tellus odio tortor. 
            Et platea placerat eget iaculis consectetur in.
            <br /><br />
            Hac nec nisi nunc rhoncus gravida. Dignissim purus nunc risus diam amet faucibus nibh lacus. 
            Dui enim nulla etiam molestie at a dictum eu dapibus. Pharetra ut sed id praesent. 
            Massa facilisi tristique massa nunc amet consequat faucibus.
          </p>
        </div>
      </div>
      ...
      <div className="absolute bottom-4 right-4 md:bottom-[38px] md:right-[38px] lg:bottom-[38px] lg:right-[38px]">
        <div className="bg-[#e5e2de] rounded-[22px] border-2 border-[#5a3e26] border-dashed p-3 md:p-4 lg:p-[18px]">
          <div className="grid grid-cols-3 gap-1 md:gap-2 lg:gap-[4px]">
            {/* Row 1 */}
            <SocialButton img={imgLinkedIn} />
            <SocialButton img={imgGitHub} />
            <SocialButton img={imgBehance} />
            
            {/* Row 2 */}
            <SocialButton img={imgNotion} />
            <SocialButton img={imgYouTube} />
            <SocialButton empty />
