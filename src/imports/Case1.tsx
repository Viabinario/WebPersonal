...
import imgLogoSocialNetworks from "../assets/eb32313f181d7f397e280d071d68cd4848de3309.png";
import imgLogoSocialNetworks1 from "../assets/ba860023c4945015a1341b916ead911ab33959ca.png";
import imgLogoSocialNetworks2 from "../assets/ce87b991d33908119ebd53423d76d4d176fa3dd6.png";
import imgLogoSocialNetworks3 from "../assets/f4070059249511aee028c2a23241923404682ade.png";
import imgLogoSocialNetworks4 from "../assets/2a49aaca2afd902bddff6a117e6ba2b56e221665.png";
import imgMacBookAir151 from "../assets/case1/0cb5ba6b2ea873b38f4fb0e296087fd701c72526.png";
import imgIPadPro1141 from "../assets/case1/289fbd019b173409a4a54cfddf2c36df34d8e847.png";
import imgIPhone16ProMax41 from "../assets/case1/477ea164a5cd85cd1175fee9ae05517d0202a3da.png";
import imgContentImage from "../assets/case1/15d4206477f326d58f8ce141222ccf93c34eaa63.png";
import imgContentImage1 from "../assets/case1/d0db9f7aca1393f8907cbb789b6a56ae32d9d2ca.png";
import imgVisualRoadmapDesign21 from "../assets/case1/0bc35c4b9f3daba82cacf71b0d7379d709c14413.png";
import imgContentImage2 from "../assets/case1/d0737a44ae884d3ea270d3dfa4e9b45c963d48cc.png";
import imgContentImage3 from "../assets/case1/c25e4b6d594805b2f57ce6b09d81c2d3a35f28fe.png";
import imgContentImage4 from "../assets/case1/5bdfed2add2a62eca1bd99338781e976848d3911.png";
import imgEstructuraDeEncuesta1 from "../assets/case1/8ed2a1829019b151334b99353eb38dd524f1770b.png";
import imgImage12 from "../assets/case1/a16c66b38cc3b3169dda3c893de90b9b8f9b03c5.png";
import imgContentImage5 from "../assets/case1/283cf19f427628fb4272a5f3dc0c54420d39661b.png";
import imgPersonas1 from "../assets/case1/240c2beb0e2aaad83905de3198e32fd8aa02f821.png";
import imgArquetipo1 from "../assets/case1/15be92f9df216c1e9eaa4e93ca23dbc690f2f680.png";
import imgUserAdultoMayor2 from "../assets/case1/5dce95db09187f33c12e81e89b9d1f43f8142990.png";
import imgMapaEmpatia1 from "../assets/case1/bd56b00d9181228cd976285a2bdb48029fbc2c13.png";
import imgBusinessModelCanvas11 from "../assets/case1/22cbd09facda3b5bf3e99427bd0e202c41810bef.png";
import imgValuePropositionKora1 from "../assets/case1/42232f63150389ad16f4b3882e980dc5c7310fe7.png";
import imgPoV1 from "../assets/case1/2372bb62b683fecbca48e5f70b548cb98f549b7e.png";
import imgMoSCoWKora1 from "../assets/case1/3ad47dcca67b4d5c729c738310cbe59192f3b4ca.png";
import imgContentImage6 from "../assets/case1/ece298d0ec2c16f10310d45724b276a6035cb503.png";
import imgIdeaEstructura1 from "../assets/case1/63155354c9ce918ce5ba3fcc2dabea6015b44500.png";
import imgCardsorting2 from "../assets/case1/3b5722f339203672f2716797bfd228374ce36fc1.png";
import imgArquitectura1 from "../assets/case1/8c072013c44fc2067b0f90be76e3217d1e22a809.png";
import imgWireframe1 from "../assets/case1/a050004f2e51dd718d44da2eaae71d95f396be11.png";
import imgVisual1 from "../assets/case1/3890ab73ef56dfb58a687dd9e63210efbd0dcb13.png";
import imgIdeaEstructura2 from "../assets/case1/77ae6d59dd76a3e4b6b73f39c38dcba805b21705.png";
import imgStyleColor2 from "../assets/case1/189230297f564719c1984ba7327d259cc9644e1e.png";
import imgFonts1 from "../assets/case1/3817f1ce994d4e7c500fff12619f0ebc4d11c71b.png";
import imgGridStyle1 from "../assets/case1/a4b6186b7a260a3913120b522eb25cd63993b0a9.png";
import imgVariables1 from "../assets/case1/e28ea558f5ccdf97b54eb6cf22e218692f75fb19.png";
import imgComImg1 from "../assets/case1/5caf0c0a3c241eaaae32ccbd314a704c47ee0f58.png";
import imgPrototype1 from "../assets/case1/a15265dd33cc274a72d7fc6f9090e5f2fc49aa5c.png";
import imgTesteo1 from "../assets/case1/d8cfe4b75bb5ea536e017a0a50a82441062127c7.png";

function ContentBodySideLeft() {
  return <div className="absolute bg-[#f7f2ed] h-[835px] left-0 min-w-[346px] top-0 w-[346px]" data-name="Content-Body-Side-Left" />;
}

function ProfilePhoto() {
  return (
    <div className="pointer-events-none relative rounded-[22px] shrink-0 size-[184px]" data-name="Profile_Photo">
      <img alt="" className="absolute inset-0 max-w-none object-cover rounded-[22px] size-full" src={imgProfilePhoto} />
      <div aria-hidden="true" className="absolute border border-[#5a3e26] border-dashed inset-0 rounded-[22px]" />
    </div>
  );
}

function ContentProfilePhoto() {
  return (
...
function BoxText() {
  return (
    <div className="bg-[#f7f2ed] flex-[1_0_0] min-h-px min-w-px relative rounded-[22px] w-[592px]" data-name="Box_text">
      <div className="content-stretch flex flex-col items-start overflow-clip px-[100px] py-[48px] relative rounded-[inherit] size-full">
        <div className="flex-[1_0_0] font-['Roboto:Regular',sans-serif] font-normal leading-[normal] min-h-px min-w-px relative text-[14px] text-black text-justify w-[385px]" style={{ fontVariationSettings: "'wdth' 100" }}>
          <p className="css-4hzbpn mb-0">Lorem ipsum dolor sit amet consectetur. Congue mauris id rhoncus adipiscing amet pharetra ornare amet luctus. Suspendisse lectus viverra sollicitudin nibh imperdiet diam vitae. Scelerisque mi urna tellus odio tortor. Et platea placerat eget iaculis consectetur in.</p>
          <p className="css-4hzbpn">Hac nec nisi nunc rhoncus gravida. Dignissim purus nunc risus diam amet faucibus nibh lacus. Dui enim nulla etiam molestie at a dictum eu dapibus. Pharetra ut sed id praesent. Massa facilisi tristique massa nunc amet consequat faucibus.</p>
        </div>
      </div>
...
function ContentCenter() {
  return (
    <div className="absolute content-stretch flex flex-col h-[835px] items-center left-[346px] min-w-[712px] top-0 w-[712px]" data-name="Content-Center">
      <ContentProfilePhoto />
      <ContentBoxText />
      <ContentForm />
    </div>
...
function LogoSocialNetworks() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 rounded-[14px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25),0px_8px_2px_0px_rgba(0,0,0,0),0px_5px_2px_0px_rgba(0,0,0,0.01),0px_3px_2px_0px_rgba(0,0,0,0.03),0px_1px_1px_0px_rgba(0,0,0,0.04)] size-[44px] top-1/2" data-name="Logo_socialNetworks">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[14px] size-full" src={imgLogoSocialNetworks} />
    </div>
  );
}

function BorderLogoSocialNetworkd() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#d9bda5] left-1/2 rounded-[16px] size-[42px] top-1/2" data-name="Border_Logo_socialNetworkd">
      <LogoSocialNetworks />
    </div>
  );
}
  ...
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 rounded-[14px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25),0px_8px_2px_0px_rgba(0,0,0,0),0px_5px_2px_0px_rgba(0,0,0,0.01),0px_3px_2px_0px_rgba(0,0,0,0.03),0px_1px_1px_0px_rgba(0,0,0,0.04)] size-[44px] top-1/2" data-name="Logo_socialNetworks">
      <div aria-hidden="true" className="absolute inset-0 pointer-events-none rounded-[14px]">
        ...
        <img alt="" className="absolute max-w-none object-cover rounded-[14px] size-full" src={imgLogoSocialNetworks1} />
      </div>
    </div>
  );
}

function BorderLogoSocialNetworkd1() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#d9bda5] left-1/2 rounded-[16px] size-[42px] top-1/2" data-name="Border_Logo_socialNetworkd">
      <LogoSocialNetworks1 />
    </div>
...
function ContentIcon1() {
  return (
    <div className="relative shrink-0 size-[48px]" data-name="Content_icon">
      <BorderLogoSocialNetworkd1 />
    </div>
  );
}

function LogoSocialNetworks2() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 rounded-[14px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25),0px_8px_2px_0px_rgba(0,0,0,0),0px_5px_2px_0px_rgba(0,0,0,0.01),0px_3px_2px_0px_rgba(0,0,0,0.03),0px_1px_1px_0px_rgba(0,0,0,0.04)] size-[44px] top-1/2" data-name="Logo_socialNetworks">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[14px] size-full" src={imgLogoSocialNetworks2} />
    </div>
  );
}

function BorderLogoSocialNetworkd2() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#d9bda5] left-1/2 rounded-[16px] size-[42px] top-1/2" data-name="Border_Logo_socialNetworkd">
      <LogoSocialNetworks2 />
    </div>
...
function ContentIcon2() {
  return (
    <div className="relative shrink-0 size-[48px]" data-name="Content_icon">
      <BorderLogoSocialNetworkd2 />
    </div>
  );
}

function ContentSocialButton() {
  return (
...
function LogoSocialNetworks3() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 rounded-[14px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25),0px_8px_2px_0px_rgba(0,0,0,0),0px_5px_2px_0px_rgba(0,0,0,0.01),0px_3px_2px_0px_rgba(0,0,0,0.03),0px_1px_1px_0px_rgba(0,0,0,0.04)] size-[44px] top-1/2" data-name="Logo_socialNetworks">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[14px] size-full" src={imgLogoSocialNetworks3} />
    </div>
  );
}

function BorderLogoSocialNetworkd3() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#d9bda5] left-1/2 rounded-[16px] size-[42px] top-1/2" data-name="Border_Logo_socialNetworkd">
      <LogoSocialNetworks3 />
    </div>
...
function ContentIcon3() {
  return (
    <div className="relative shrink-0 size-[48px]" data-name="Content_icon">
      <BorderLogoSocialNetworkd3 />
    </div>
  );
}

function LogoSocialNetworks4() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute left-1/2 rounded-[14px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25),0px_8px_2px_0px_rgba(0,0,0,0),0px_5px_2px_0px_rgba(0,0,0,0.01),0px_3px_2px_0px_rgba(0,0,0,0.03),0px_1px_1px_0px_rgba(0,0,0,0.04)] size-[44px] top-1/2" data-name="Logo_socialNetworks">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[14px] size-full" src={imgLogoSocialNetworks4} />
    </div>
  );
}

function BorderLogoSocialNetworkd4() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#d9bda5] left-1/2 rounded-[16px] size-[42px] top-1/2" data-name="Border_Logo_socialNetworkd">
      <LogoSocialNetworks4 />
    </div>
...
function ContentIcon4() {
  return (
    <div className="relative shrink-0 size-[48px]" data-name="Content_icon">
      <BorderLogoSocialNetworkd4 />
    </div>
  );
}

function LogoSocialNetworks5() {
  return <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#f7f2ed] left-1/2 rounded-[14px] size-[44px] top-1/2" data-name="Logo_socialNetworks" />;
}

function BorderLogoSocialNetworkd5() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#d9bda5] left-1/2 rounded-[16px] size-[42px] top-1/2" data-name="Border_Logo_socialNetworkd">
      <LogoSocialNetworks5 />
    </div>
...
function ContentIcon5() {
  return (
    <div className="relative shrink-0 size-[48px]" data-name="Content_icon">
      <BorderLogoSocialNetworkd5 />
    </div>
  );
}

function ContentSocialButton1() {
  return (
    <div className="content-stretch flex gap-[4px] items-center justify-center relative shrink-0 w-full" data-name="Content_SocialButton">
      <ContentIcon3 />
      <ContentIcon4 />
...
function LogoSocialNetworks6() {
  return <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#f7f2ed] left-1/2 rounded-[14px] size-[44px] top-1/2" data-name="Logo_socialNetworks" />;
}

function BorderLogoSocialNetworkd6() {
  return (
    <div className="-translate-x-1/2 -translate-y-1/2 absolute bg-[#d9bda5] left-1/2 rounded-[16px] size-[42px] top-1/2" data-name="Border_Logo_socialNetworkd">
      <LogoSocialNetworks6 />
    </div>
...
function ContentIcon6() {
  return (
    <div className="relative shrink-0 size-[48px]" data-name="Content_icon">
      <BorderLogoSocialNetworkd6 />
    </div>
  );
}

function ContentSocialButton2() {
  return (
    <div className="content-stretch flex gap-[4px] items-center justify-center relative shrink-0 w-full" data-name="Content_SocialButton">
...
function SocialNetworks() {
  return (
    <div className="bg-[#e5e2de] h-[314px] relative rounded-[22px] shrink-0 w-[184px]" data-name="Social_Networks">
      <div className="content-stretch flex flex-col gap-[10px] items-start overflow-clip py-[18px] relative rounded-[inherit] size-full">
        <ContentSocialButton />
        <ContentSocialButton1 />
        {[...Array(3).keys()].map((_, i) => (
          <ContentSocialButton2 key={i} />
        ))}
      </div>
...
function ContentSocialNetworks() {
  return (
    <div className="content-stretch flex flex-col h-[314px] items-start relative shrink-0 w-full" data-name="Content-SocialNetworks">
      <SocialNetworks />
    </div>
  );
}
...
function ContentRight() {
  return (
    <div className="absolute content-stretch flex flex-col h-[835px] items-start justify-end left-[1058px] min-w-[222px] top-0 w-[222px]" data-name="Content-Right">
...
function ContentLeft184Px() {
  return <div className="bg-[#f7f2ed] h-[670px] shrink-0 w-[184px]" data-name="Content_Left_184px" />;
}
...
function ContentText7() {
  return (
    <div className="content-stretch flex flex-col h-[332px] items-start relative shrink-0 w-full" data-name="content-text">
      <ModuleText4 />
    </div>
  );
}
...
function ContentImage1() {
  return (
    <div className="h-[267px] relative rounded-[8px] shrink-0 w-[372px]" data-name="Content-Image">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[8px] size-full" src={imgContentImage} />
    </div>
  );
}
...
function IconChapters() {
  return (
    <div className="relative shrink-0 size-[48px]" data-name="Icon-Chapters">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
        <g id="Icon-Chapters">
          <path d={svgPaths.p17155500} fill="var(--fill-0, #5A3E26)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function IconTitleSection() {
  return (
    <div className="content-stretch flex gap-[16px] items-center relative shrink-0" data-name="Icon-Title-Section">
      <IconChapters />
...
function ContentImage2() {
  return (
    <div className="h-[338px] relative rounded-[8px] shrink-0 w-full" data-name="Content-Image">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[8px] size-full" src={imgContentImage1} />
...
function ContentText13() {
  return (
    <div className="content-stretch flex flex-col items-center relative shrink-0 w-[135px]" data-name="content-text">
      <ModuleText7 />
    </div>
  );
}
    ...
    <div className="bg-[#f7f2ed] h-[670px] relative rounded-[22px] shrink-0 w-[1000px]" data-name="Content_Project_1000px">
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip relative rounded-[inherit] size-full">
        <div className="h-[654.55px] relative shadow-[0px_2.6px_3.9px_0px_rgba(0,0,0,0.04),0px_6.5px_11.7px_0px_rgba(0,0,0,0.05),0px_11.7px_36.4px_0px_rgba(0,0,0,0.1)] shrink-0 w-[900.9px]" data-name="Visual Roadmap Design 2 1">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgVisualRoadmapDesign21} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#b2b0ad] border-dashed inset-0 pointer-events-none rounded-[22px]" />
    </div>
...
function ContentImage3() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[8px] w-full" data-name="Content-Image">
      <img alt="" className="absolute inset-0 max-w-none object-cover opacity-40 pointer-events-none rounded-[8px] size-full" src={imgContentImage2} />
      <div className="size-full" />
      <div aria-hidden="true" className="absolute border border-[#5a3e26] border-dashed inset-0 pointer-events-none rounded-[8px]" />
    </div>
  );
...
function IconChapters1() {
  return (
    <div className="relative shrink-0 size-[48px]" data-name="Icon-Chapters">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
        <g id="Icon-Chapters">
          <path d={svgPaths.p32bfe300} fill="var(--fill-0, #5A3E26)" id="Vector" />
        </g>
      </svg>
    </div>
  );
    ...
    <div className="absolute contents left-0 top-0">
      ...
      <div className="absolute flex h-[93px] items-center justify-center left-[48.1px] top-[97.4px] w-0" style={{ "--transform-inner-width": "300", "--transform-inner-height": "150" } as React.CSSProperties}>
        <div className="flex-none rotate-90">
          <div className="h-0 relative w-[93px]">
            <div className="absolute inset-[-10.39px_0]" style={{ "--stroke-0": "rgba(45, 0, 151, 1)" } as React.CSSProperties}>
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 93 20.7846">
                <path d={svgPaths.pd7a4480} fill="var(--stroke-0, #2D0097)" id="Arrow 1" />
              </svg>
            </div>
          </div>
        </div>
      </div>
      <div className="absolute flex h-[93px] items-center justify-center left-[247.6px] top-[97.4px] w-0" style={{ "--transform-inner-width": "300", "--transform-inner-height": "150" } as React.CSSProperties}>
        <div className="flex-none rotate-90">
          <div className="h-0 relative w-[93px]">
            <div className="absolute inset-[-10.39px_0]" style={{ "--stroke-0": "rgba(45, 0, 151, 1)" } as React.CSSProperties}>
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 93 20.7846">
      ...
      <div className="absolute flex h-[93px] items-center justify-center left-[447px] top-[97.4px] w-0" style={{ "--transform-inner-width": "300", "--transform-inner-height": "150" } as React.CSSProperties}>
        <div className="flex-none rotate-90">
          <div className="h-0 relative w-[93px]">
            <div className="absolute inset-[-10.39px_0]" style={{ "--stroke-0": "rgba(45, 0, 151, 1)" } as React.CSSProperties}>
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 93 20.7846">
...
function DesignThinking() {
  return (
    <div className="h-[226px] relative shrink-0 w-[526px]" data-name="Design Thinking">
      <Group1 />
    </div>
  );
}
...
function ContentText17() {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[280px]" data-name="content-text">
      <ModuleText9 />
    </div>
  );
}
...
function Content1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] items-center justify-between min-h-px min-w-px relative w-[576px]" data-name="Content">
      <ContentText17 />
      <ContentText19 />
    </div>
  );
...
function ContentImage5() {
  return (
    <div className="h-[626px] relative rounded-[8px] shrink-0 w-[376px]" data-name="Content-Image">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[8px] size-full" src={imgContentImage3} />
    </div>
  );
}
...
function Content2() {
  return (
    <div className="content-stretch flex flex-col h-[626px] items-start justify-between relative shrink-0 w-[184px]" data-name="Content">
      <ContentText21 />
    </div>
  );
}
...
function ContentImage6() {
  return (
    <div className="h-[626px] relative rounded-[8px] shrink-0 w-[376px]" data-name="Content-Image">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[8px] size-full" src={imgContentImage4} />
    </div>
  );
}
  ...
  return (
    <div className="content-stretch flex flex-col gap-[10px] h-[626px] items-center relative rounded-[8px] shrink-0 w-[376px]" data-name="Content-Image">
      ...
      <div className="aspect-[1127/869] relative shadow-[0px_4px_6px_0px_rgba(0,0,0,0.1),0px_10px_18px_0px_rgba(0,0,0,0.13),0px_18px_56px_0px_rgba(0,0,0,0.26)] shrink-0 w-full" data-name="Estructura de Encuesta 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgEstructuraDeEncuesta1} />
      </div>
      <div className="h-[301px] relative shrink-0 w-[320px]" data-name="image 12">
...
function ContentImage8() {
  return (
    <div className="h-[372px] relative rounded-[8px] shrink-0 w-full" data-name="Content-Image">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[8px] size-full" src={imgContentImage5} />
      <div className="size-full" />
    </div>
  );
}

function IconChapters2() {
  return (
    <div className="relative shrink-0 size-[48px]" data-name="Icon-Chapters">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
        <g id="Icon-Chapters">
          <path d={svgPaths.p1fe9fb00} fill="var(--fill-0, #5A3E26)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function ContentImage9() {
  return (
    <div className="relative rounded-[8px] shrink-0 w-full" data-name="Content_Image">
      <div aria-hidden="true" className="absolute border border-[#5a3e26] border-dashed inset-0 pointer-events-none rounded-[8px]" />
      <div className="content-stretch flex items-start justify-between p-[10px] relative w-full">
        <div className="h-[450px] relative shrink-0 w-[411px]" data-name="Personas 1">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgPersonas1} />
        </div>
        <div className="h-[450px] relative shrink-0 w-[304px]" data-name="ARQUETIPO 1">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgArquetipo1} />
        </div>
      </div>
    </div>
  );
...
function ContentText29() {
  return (
    <div className="content-stretch flex flex-col h-[148px] items-start relative shrink-0 w-[770px]" data-name="content-text">
      <ModuleText15 />
    </div>
  );
}

function ContentProject796Px() {
  return (
    <div className="bg-[#f7f2ed] h-[670px] relative rounded-[22px] shrink-0 w-[796px]" data-name="Content_Project_796px">
      <div className="content-stretch flex flex-col gap-[8px] items-start overflow-clip px-[8px] py-[22px] relative rounded-[inherit] size-full">
        <ContentImage9 />
        <ContentText29 />
      </div>
      <div aria-hidden="true" className="absolute border border-[#b2b0ad] border-dashed inset-0 pointer-events-none rounded-[22px]" />
...
function Frame() {
  return (
    <div className="h-[470px] relative rounded-[8px] shrink-0 w-full">
      <div aria-hidden="true" className="absolute border border-[#5a3e26] border-dashed inset-0 pointer-events-none rounded-[8px]" />
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-[10px] relative size-full">
          <div className="h-[450px] relative shrink-0 w-[681px]" data-name="USER - Adulto Mayor 2">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgUserAdultoMayor2} />
          </div>
        </div>
      </div>
    </div>
...
function ContentText31() {
  return (
    <div className="content-stretch flex flex-col h-[148px] items-start relative shrink-0 w-full" data-name="content-text">
      <ModuleText16 />
    </div>
  );
}

function ContentProject796Px1() {
  return (
    <div className="bg-[#f7f2ed] h-[670px] relative rounded-[22px] shrink-0 w-[796px]" data-name="Content_Project_796px">
      <div className="content-stretch flex flex-col gap-[8px] items-start overflow-clip px-[8px] py-[22px] relative rounded-[inherit] size-full">
        <Frame />
    ...
    <div className="relative rounded-[8px] shrink-0 w-full">
      ...
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center p-[10px] relative w-full">
          <div className="h-[450px] relative shrink-0 w-[453px]" data-name="Mapa empatía 1">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgMapaEmpatia1} />
          </div>
        </div>
      </div>
    </div>
...
function ContentProject592Px5() {
  return (
    <div className="bg-[#f7f2ed] h-[670px] relative rounded-[22px] shrink-0 w-[592px]" data-name="Content_Project_592px">
      <div className="content-stretch flex flex-col gap-[8px] items-start overflow-clip px-[8px] py-[22px] relative rounded-[inherit] size-full">
        <Frame1 />
        <ContentText33 />
      </div>
...
function Frame2() {
  return (
    <div className="h-[470px] relative rounded-[8px] shrink-0 w-full">
      ...
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-[10px] relative size-full">
          <div className="h-[450px] relative shrink-0 w-[738px]" data-name="Business Model Canvas 1 1">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgBusinessModelCanvas11} />
          </div>
        </div>
      </div>
    </div>
...
function ContentText35() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="content-text">
      <ModuleText18 />
    </div>
  );
}

function ContentProject796Px2() {
  return (
    <div className="bg-[#f7f2ed] h-[670px] relative rounded-[22px] shrink-0 w-[796px]" data-name="Content_Project_796px">
      <div className="content-stretch flex flex-col gap-[8px] items-start overflow-clip px-[8px] py-[22px] relative rounded-[inherit] size-full">
        <Frame2 />
...
function Frame3() {
  return (
    <div className="h-[470px] relative rounded-[8px] shrink-0 w-full">
      ...
      <div className="flex flex-col items-center justify-center size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-[10px] relative size-full">
          <div className="h-[415px] relative shrink-0 w-[740px]" data-name="Value Proposition - KORA 1">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgValuePropositionKora1} />
          </div>
        </div>
      </div>
    </div>
...
function ContentText39() {
  return (
    <div className="content-stretch flex flex-col h-[131px] items-start relative shrink-0 w-[480px]" data-name="content-text">
      <ModuleText20 />
    </div>
  );
}

function ContentTitle21() {
  return <div className="h-[29.688px] shrink-0 w-full" data-name="Content_title" />;
}
...
function Content2Column() {
  return (
    <div className="h-[148px] relative shrink-0 w-full" data-name="Content-2-column">
  ...
  return (
    <div className="bg-[#f7f2ed] content-stretch flex flex-col gap-[8px] h-[670px] items-center px-[8px] py-[22px] relative rounded-[22px] shrink-0 w-[1000px]" data-name="Content_Project_1000px">
      ...
      <div className="h-[470px] relative rounded-[8px] shrink-0 w-[954px]" data-name="PoV 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[8px] size-full" src={imgPoV1} />
      </div>
      <Content2Column />
    </div>
  );
...
function Frame4() {
  return (
    <div className="relative rounded-[8px] shrink-0 w-full">
      ...
      <div className="flex flex-col items-center size-full">
        <div className="content-stretch flex flex-col items-center p-[10px] relative w-full">
          <div className="h-[450px] relative shrink-0 w-[409px]" data-name="MoSCoW - KORA 1">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgMoSCoWKora1} />
          </div>
        </div>
      </div>
    </div>
...
function ContentImage10() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative rounded-[8px] w-full" data-name="Content-Image">
      <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[8px] size-full" src={imgContentImage6} />
      <div className="flex flex-col items-center justify-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center justify-center p-[10px] relative size-full">
          <div className="relative shrink-0 size-[372px]" data-name="idea_estructura 1">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgIdeaEstructura1} />
          </div>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#5a3e26] border-dashed inset-0 pointer-events-none rounded-[8px]" />
...
function IconChapters3() {
  return (
    <div className="relative shrink-0 size-[48px]" data-name="Icon-Chapters">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
        <g id="Icon-Chapters">
          <path d={svgPaths.p279daa00} fill="var(--fill-0, #5A3E26)" id="Vector" />
        </g>
      </svg>
    </div>
  );
...
function ContentText45() {
  return (
    <div className="content-stretch flex flex-col h-[168px] items-start relative shrink-0 w-full" data-name="content-text">
      <ModuleText23 />
    </div>
  );
}

function ContentProject388Px() {
  return (
    <div className="bg-[#fff6eb] h-[670px] relative rounded-[22px] shrink-0 w-[388px]" data-name="Content_Project_388px">
      <div className="content-stretch flex flex-col gap-[22px] items-start justify-end overflow-clip px-[8px] py-[22px] relative rounded-[inherit] size-full">
        <ContentImage10 />
        <IconTitleSection3 />
        <ContentText45 />
...
function ContentText47() {
  return (
    <div className="content-stretch flex flex-col h-full items-start relative shrink-0 w-[505px]" data-name="content-text">
      <ModuleText24 />
    </div>
  );
}

function Content2Column1() {
  return (
    <div className="h-[159px] relative shrink-0 w-full" data-name="Content-2-column">
      <div className="flex flex-row justify-end size-full">
        <div className="content-stretch flex items-start justify-end px-[22px] relative size-full">
          <ContentText47 />
        </div>
      </div>
    </div>
  ...
  return (
    <div className="bg-[#f7f2ed] content-stretch flex flex-col gap-[8px] h-[670px] items-center px-[8px] py-[22px] relative rounded-[22px] shrink-0 w-[1000px]" data-name="Content_Project_1000px">
      ...
      <div className="h-[459px] relative shrink-0 w-[946px]" data-name="CARDSORTING 2">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgCardsorting2} />
      </div>
      <Content2Column1 />
    </div>
  );
...
function ContentText51() {
  return (
    <div className="content-stretch flex flex-col h-[159px] items-start relative shrink-0 w-[505px]" data-name="content-text">
      <ModuleText26 />
    </div>
  );
}

function Content2Column2() {
  return (
    <div className="h-[168px] relative shrink-0 w-full" data-name="Content-2-column">
      <div className="content-stretch flex gap-[1016px] items-start px-[47px] relative size-full">
        <ContentText49 />
        <ContentText51 />
      </div>
    </div>
  ...
  return (
    <div className="bg-[#f7f2ed] content-stretch flex flex-col gap-[8px] h-[670px] items-center px-[8px] py-[22px] relative rounded-[22px] shrink-0 w-[2158px]" data-name="Content_Project_1000px">
      ...
      <div className="h-[450px] relative shrink-0 w-[2046px]" data-name="ARQUITECTURA 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgArquitectura1} />
      </div>
      <Content2Column2 />
    </div>
  );
...
function ModuleText27() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[10px] items-start min-h-px min-w-px py-[6px] relative w-full" data-name="Module-Text">
      <ContentTitle27 />
      <ContentText52 />
    </div>
  );
...
function ContentText53() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col items-start min-h-px min-w-px relative w-[135px]" data-name="content-text">
      <ModuleText27 />
    </div>
  );
}
      ...
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center p-[10px] relative w-full">
          <div className="h-[618px] relative shrink-0 w-[549px]" data-name="visual 1">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgVisual1} />
          </div>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#5a3e26] border-dashed inset-0 pointer-events-none rounded-[8px]" />
    ...
    <div className="h-[287px] relative rounded-[8px] shrink-0 w-[372px]" data-name="Content-Image">
      ...
      <div className="content-stretch flex flex-col items-center justify-center overflow-clip p-[10px] relative rounded-[inherit] size-full">
        <div className="relative shrink-0 size-[372px]" data-name="idea_estructura 2">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgIdeaEstructura2} />
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#5a3e26] border-dashed inset-0 pointer-events-none rounded-[8px]" />
    </div>
...
function IconChapters4() {
  return (
    <div className="relative shrink-0 size-[48px]" data-name="Icon-Chapters">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
        <g id="Icon-Chapters">
          <path d={svgPaths.pccfee00} id="Vector" stroke="var(--stroke-0, #5A3E26)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="3" />
        </g>
      </svg>
    </div>
  );
...
function ContentText55() {
  return (
    <div className="content-stretch flex flex-col h-[247px] items-start relative shrink-0 w-full" data-name="content-text">
      <ModuleText28 />
    </div>
  );
}
    ...
    <div className="h-[201.217px] relative shrink-0 w-full" data-name="Content_text">
      <div className="absolute font-['Roboto:Regular',sans-serif] font-normal inset-0 leading-[0] text-[#5a3e26] text-[14px] text-justify" style={{ fontVariationSettings: "'wdth' 100" }}>
        <ul className="list-disc mb-0">
          ...
          <li className="css-4hzbpn mb-0 ms-[21px]">
            <span className="leading-[normal]">Style Grid</span>
          </li>
          <li className="css-4hzbpn mb-0 ms-[21px]">
            <span className="leading-[normal]">Style Typography</span>
          </li>
          <li className="css-4hzbpn mb-0 ms-[21px]">
            <span className="leading-[normal]">Shadows</span>
          </li>
      ...
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center p-[10px] relative size-full">
          <div className="h-[614.4px] relative shrink-0 w-[434.25px]" data-name="Style_color 2">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgStyleColor2} />
          </div>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#5a3e26] border-dashed inset-0 pointer-events-none rounded-[8px]" />
  ...
  return (
    <div className="h-[558px] relative shrink-0 w-[538px]" data-name="Styles">
      <div className="absolute h-[476.5px] left-0 top-0 w-[214.5px]" data-name="Fonts 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgFonts1} />
      </div>
      <div className="absolute h-[217px] left-[215px] top-[12px] w-[323px]" data-name="grid_style 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgGridStyle1} />
      </div>
      <div className="absolute h-[230px] left-[215px] shadow-[0px_4px_4px_0px_rgba(0,0,0,0.25)] top-[299px] w-[319px]" data-name="Variables 1">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgVariables1} />
      </div>
    </div>
  );
}
  ...
  return (
    <div className="h-[201.217px] relative shrink-0 w-full" data-name="Content_text">
      <ul className="absolute block font-['Roboto:Regular',sans-serif] font-normal inset-0 leading-[0] text-[#5a3e26] text-[14px] text-justify" style={{ fontVariationSettings: "'wdth' 100" }}>
        ...
        <li className="css-4hzbpn mb-0 ms-[21px]">
          <span className="leading-[normal]">Logo</span>
        </li>
        <li className="css-4hzbpn mb-0 ms-[21px]">
          <span className="leading-[normal]">Avatar</span>
        </li>
        <li className="css-4hzbpn mb-0 ms-[21px]">
          <span className="leading-[normal]">Bars</span>
        </li>
        <li className="css-4hzbpn mb-0 ms-[21px]">
          <span className="leading-[normal]">Button</span>
        </li>
        <li className="css-4hzbpn mb-0 ms-[21px]">
          <span className="leading-[normal]">Card</span>
        </li>
        <li className="css-4hzbpn mb-0 ms-[21px]">
          <span className="leading-[normal]">List-item</span>
        </li>
        <li className="css-4hzbpn mb-0 ms-[21px]">
          <span className="leading-[normal]">Navigation-bar</span>
        </li>
        <li className="css-4hzbpn mb-0 ms-[21px]">
          <span className="leading-[normal]">Text-input</span>
        </li>
        <li className="css-4hzbpn mb-0 ms-[21px]">
          <span className="leading-[normal]">Forms</span>
        </li>
        <li className="css-4hzbpn mb-0 ms-[21px]">
          <span className="leading-[normal]">Text-Area</span>
        </li>
        <li className="css-4hzbpn mb-0 ms-[21px]">
          <span className="leading-[normal]">Toogle-Switch</span>
        </li>
        <li className="css-4hzbpn ms-[21px]">
          <span className="leading-[normal]">Search-Bar</span>
        </li>
      </ul>
    </div>
  );
...
function ContentImage15() {
  return (
    <div className="bg-white flex-[1_0_0] h-[626px] min-h-px min-w-px relative rounded-[8px]" data-name="Content-Image">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center p-[10px] relative size-full">
          <div className="h-[610px] relative shrink-0 w-[542px]" data-name="ComIMG 1">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgComImg1} />
          </div>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#5a3e26] border-dashed inset-0 pointer-events-none rounded-[8px]" />
    ...
    <div className="h-[201.217px] relative shrink-0 w-full" data-name="Content_text">
      <div className="absolute font-['Roboto:Regular',sans-serif] font-normal inset-0 leading-[0] text-[#5a3e26] text-[14px] text-justify" style={{ fontVariationSettings: "'wdth' 100" }}>
        <ul className="list-disc mb-0">
          ...
          <li className="css-4hzbpn mb-0 ms-[21px]">
            <span className="leading-[normal]">Home-Senior</span>
          </li>
          <li className="css-4hzbpn mb-0 ms-[21px]">
            <span className="leading-[normal]">Home-Joven</span>
          </li>
          <li className="css-4hzbpn mb-0 ms-[21px]">
            <span className="leading-[normal]">Video cam</span>
          </li>
          <li className="css-4hzbpn mb-0 ms-[21px]">
            <span className="leading-[normal]">Card</span>
          </li>
          <li className="css-4hzbpn mb-0 ms-[21px]">
            <span className="leading-[normal]">Chat</span>
          </li>
          <li className="css-4hzbpn ms-[21px]">
            <span className="leading-[normal]">Flujos</span>
          </li>
        </ul>
        <p className="css-4hzbpn leading-[normal]">&nbsp;</p>
      </div>
...
function ContentImage16() {
  return (
    <div className="bg-white flex-[1_0_0] h-[626px] min-h-px min-w-px relative rounded-[8px]" data-name="Content-Image">
      <div className="flex flex-col items-center overflow-clip rounded-[inherit] size-full">
        <div className="content-stretch flex flex-col items-center p-[10px] relative size-full">
          <div className="h-[610px] relative shrink-0 w-[387px]" data-name="prototype 1">
            <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none size-full" src={imgPrototype1} />
          </div>
        </div>
      </div>
      <div aria-hidden="true" className="absolute border border-[#5a3e26] border-dashed inset-0 pointer-events-none rounded-[8px]" />
...
function IconChapters5() {
  return (
    <div className="relative shrink-0 size-[48px]" data-name="Icon-Chapters">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 48 48">
        <g id="Icon-Chapters">
          <path d={svgPaths.p3e602b00} fill="var(--fill-0, #5A3E26)" id="Vector" />
          <path d={svgPaths.p255a8e70} fill="var(--fill-0, #5A3E26)" id="Vector_2" />
        </g>
      </svg>
    </div>
  );
...
function IconTitleSection5() {
  return (
    <div className="content-stretch flex gap-[8px] items-center relative shrink-0" data-name="Icon-Title-Section">
      <IconChapters5 />
      <div className="flex flex-row items-center self-stretch">
        <ContentTextIcon5 />
      </div>
...
function ContentProject388Px1() {
  return (
    <div className="bg-[#fff6eb] h-[670px] relative rounded-[22px] shrink-0 w-[286px]" data-name="Content_Project_388px">
...
function Feedback() {
  return <div className="h-[325px] shrink-0 w-[370px]" data-name="feedback" />;
}

function ContentResume388Px6() {
  return (
    <div className="bg-[#f7f2ed] h-[670px] relative rounded-[22px] shrink-0 w-[388px]" data-name="Content_Resume_388px">
      <div className="content-stretch flex flex-col gap-[62px] items-start overflow-clip px-[8px] py-[36px] relative rounded-[inherit] size-full">
        <div className="h-[200px] relative rounded-[8px] shrink-0 w-[372px]" data-name="testeo 1">
          <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[8px] size-full" src={imgTesteo1} />
        </div>
        <Feedback />
      </div>
      <div aria-hidden="true" className="absolute border border-[#b2b0ad] border-dashed inset-0 pointer-events-none rounded-[22px]" />
  ...
  return (
    <div className="h-[201.217px] relative shrink-0 w-full" data-name="Content_text">
      <div className="absolute font-['Roboto:Regular',sans-serif] font-normal inset-0 leading-[normal] text-[#5a3e26] text-[14px] text-justify" style={{ fontVariationSettings: "'wdth' 100" }}>
        ...
        <p className="css-4hzbpn mb-0">A los amigos y amigas que colaboraron, con las encuestas y testeos y actividades de research UX / UI.</p>
        <p className="css-4hzbpn mb-0">&nbsp;</p>
...
function ContentProject1000Px5() {
  return (
    <div className="bg-[#f7f2ed] h-[670px] relative rounded-[22px] shrink-0 w-[1000px]" data-name="Content_Project_1000px">
...
function ContentOtherFormats() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start pt-[250px] relative shrink-0 w-[184px]" data-name="Content-Other-Formats">
...
function ConentHorizontalProjectCase() {
  return (
    <div className="absolute content-stretch flex gap-[20px] items-start left-0 overflow-x-auto overflow-y-clip px-[38px] top-[21px]" data-name="Conent-Horizontal-ProjectCase">
      <ContentLeft184Px />
      <ContentResume388Px />
      <ContentProject592Px />
      <ContentResume388Px1 />
      ...
      <ContentResume388Px4 />
      <ContentProject796Px />
      <ContentProject796Px1 />
      <ContentProject592Px5 />
      <ContentProject796Px2 />
      <ContentProject796Px3 />
      <ContentProject1000Px1 />
      <ContentProject592Px6 />
      <ContentProject388Px />
      <ContentProject1000Px2 />
      <ContentProject1000Px3 />
      <ContentProject1000Px4 />
      <ContentTitle184Px1 />
      ...
      <ContentTitle184Px3 />
      <ContentProject592Px10 />
      <ContentTitle184Px4 />
      <ContentProject592Px11 />
...
function UsecaseContainer1280X() {
  return (
    <div className="absolute bg-[#f7f2ed] border-[#7e5635] border-dashed border-r h-[712px] left-0 overflow-x-auto overflow-y-clip top-0 w-[1280px]" data-name="Usecase_container_1280x712">
...
export default function Case() {
  return (
    <div className="bg-[#f7f2ed] relative size-full" data-name="Case 1">
      <MatrixV />
