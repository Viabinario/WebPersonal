...
function ConentHorizontalProjectCase() {
  return (
    <div className="absolute content-stretch flex gap-[20px] items-start left-0 overflow-x-auto overflow-y-clip top-[21px]" data-name="Conent-Horizontal-ProjectCase">
      <ContentLeft184Px />
      <ContentResume388Px />
      <ContentProject592Px />
      <ContentResume388Px1 />
